<?php
	...
	{
		// Get data if contact data belongs to user and the "first" row matches the key.
		$sql = "SELECT last, first, phone, id, email, address FROM contacts WHERE (last LIKE '%" . $inData["key"] . "%' OR first LIKE '%" . $inData["key"] . "%') AND userId= '" . $inData["id"] . "'"; 
